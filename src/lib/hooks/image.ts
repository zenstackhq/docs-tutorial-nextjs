...
export function useCreateImage(options?: MutationOptions<Prisma.ImageGetPayload<Prisma.ImageCreateArgs> | undefined, unknown, Prisma.ImageCreateArgs>) {
...
export function useFindManyImage<T extends Prisma.ImageFindManyArgs>(args?: Prisma.SelectSubset<T, Prisma.ImageFindManyArgs>, options?: QueryOptions<Array<Prisma.ImageGetPayload<T> & { $optimistic?: boolean }>>) {
    return request.useModelQuery('Image', 'findMany', args, options);
}

export function useInfiniteFindManyImage<T extends Prisma.ImageFindManyArgs, R extends Array<Prisma.ImageGetPayload<T>>>(getNextArgs: GetNextArgs<Prisma.SelectSubset<T, Prisma.ImageFindManyArgs> | undefined, R>, options?: InfiniteQueryOptions<Array<Prisma.ImageGetPayload<T>>>) {
    return request.useInfiniteModelQuery('Image', 'findMany', getNextArgs, options);
}

export function useFindUniqueImage<T extends Prisma.ImageFindUniqueArgs>(args?: Prisma.SelectSubset<T, Prisma.ImageFindUniqueArgs>, options?: QueryOptions<Prisma.ImageGetPayload<T> & { $optimistic?: boolean }>) {
    return request.useModelQuery('Image', 'findUnique', args, options);
}

export function useFindFirstImage<T extends Prisma.ImageFindFirstArgs>(args?: Prisma.SelectSubset<T, Prisma.ImageFindFirstArgs>, options?: QueryOptions<Prisma.ImageGetPayload<T> & { $optimistic?: boolean }>) {
    return request.useModelQuery('Image', 'findFirst', args, options);
}

export function useUpdateImage(options?: MutationOptions<Prisma.ImageGetPayload<Prisma.ImageUpdateArgs> | undefined, unknown, Prisma.ImageUpdateArgs>) {
...
export function useUpdateManyImage(options?: MutationOptions<Prisma.BatchPayload, unknown, Prisma.ImageUpdateManyArgs>) {
...
export function useUpsertImage(options?: MutationOptions<Prisma.ImageGetPayload<Prisma.ImageUpsertArgs> | undefined, unknown, Prisma.ImageUpsertArgs>) {
...
export function useDeleteImage(options?: MutationOptions<Prisma.ImageGetPayload<Prisma.ImageDeleteArgs> | undefined, unknown, Prisma.ImageDeleteArgs>) {
...
export function useDeleteManyImage(options?: MutationOptions<Prisma.BatchPayload, unknown, Prisma.ImageDeleteManyArgs>) {
...
export function useGroupByImage<T extends Prisma.ImageGroupByArgs, HasSelectOrTake extends Prisma.Or<Prisma.Extends<'skip', Prisma.Keys<T>>, Prisma.Extends<'take', Prisma.Keys<T>>>, OrderByArg extends Prisma.True extends HasSelectOrTake ? { orderBy: Prisma.ImageGroupByArgs['orderBy'] } : { orderBy?: Prisma.ImageGroupByArgs['orderBy'] }, OrderFields extends Prisma.ExcludeUnderscoreKeys<Prisma.Keys<Prisma.MaybeTupleToUnion<T['orderBy']>>>, ByFields extends Prisma.MaybeTupleToUnion<T['by']>, ByValid extends Prisma.Has<ByFields, OrderFields>, HavingFields extends Prisma.GetHavingFields<T['having']>, HavingValid extends Prisma.Has<ByFields, HavingFields>, ByEmpty extends T['by'] extends never[] ? Prisma.True : Prisma.False, InputErrors extends ByEmpty extends Prisma.True
    ...
    : {
        ...
        ? never
        : `Error: Field "${P}" in "orderBy" needs to be provided in "by"`
    }[OrderFields]>(args?: Prisma.SubsetIntersection<T, Prisma.ImageGroupByArgs, OrderByArg> & InputErrors, options?: QueryOptions<{} extends InputErrors ?
        Array<PickEnumerable<Prisma.ImageGroupByOutputType, T['by']> &
            {
...
export function useCountImage<T extends Prisma.ImageCountArgs>(args?: Prisma.Subset<T, Prisma.ImageCountArgs>, options?: QueryOptions<T extends { select: any; } ? T['select'] extends true ? number : Prisma.GetScalarType<T['select'], Prisma.ImageCountAggregateOutputType> : number>) {
