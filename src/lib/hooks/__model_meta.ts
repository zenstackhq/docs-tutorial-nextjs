        ...
        content: {
            name: 'Content', fields: {
                id: {
                    ...
                    defaultValueProvider: $default$Content$authorId,
                }, contentType: {
                    name: "contentType",
                    type: "String",
                }, likes: {
        ...
        image: {
            name: 'Image', baseTypes: ['Content'], fields: {
                id: {
                    ...
                    isForeignKey: true,
                    relationField: 'author',
                    defaultValueProvider: $default$Image$authorId,
                    inheritedFrom: "Content",
                }, contentType: {
                    name: "contentType",
                    type: "String",
        ...
        like: {
            name: 'Like', fields: {
                id: {
                    ...
                    isForeignKey: true,
                    relationField: 'author',
                    defaultValueProvider: $default$Like$authorId,
                }, content: {
                    name: "content",
                    type: "Content",
                    isDataModel: true,
...
function $default$Content$authorId(user: any): unknown {
    return user?.id;
}
...
function $default$Image$authorId(user: any): unknown {
    return user?.id;
}

function $default$Like$authorId(user: any): unknown {
    return user?.id;
}
