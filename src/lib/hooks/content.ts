...
export function useMutateContent() {
    ...
    const invalidate = request.useInvalidation('Content', metadata);

    /** @deprecated Use `useCreateContent` hook instead. */
    async function createContent<T extends Prisma.ContentCreateArgs>(
        args: Prisma.SelectSubset<T, Prisma.ContentCreateArgs>,
    ) {
        return await request.mutationRequest<Prisma.ContentGetPayload<Prisma.ContentCreateArgs> | undefined, true>(
            'POST',
    ...
    async function updateContent<T extends Prisma.ContentUpdateArgs>(
        args: Prisma.SelectSubset<T, Prisma.ContentUpdateArgs>,
    ) {
        return await request.mutationRequest<Prisma.ContentGetPayload<Prisma.ContentUpdateArgs> | undefined, true>(
            'PUT',
    ...
    /** @deprecated Use `useUpdateManyContent` hook instead. */
    async function updateManyContent<T extends Prisma.ContentUpdateManyArgs>(
        args: Prisma.SelectSubset<T, Prisma.ContentUpdateManyArgs>,
    ) {
        return await request.mutationRequest<Prisma.BatchPayload, false>(
            'PUT',
            `${endpoint}/content/updateMany`,
            args,
            invalidate,
            fetch,
            false,
    ...
    /** @deprecated Use `useUpsertContent` hook instead. */
    async function upsertContent<T extends Prisma.ContentUpsertArgs>(
        args: Prisma.SelectSubset<T, Prisma.ContentUpsertArgs>,
    ) {
        return await request.mutationRequest<Prisma.ContentGetPayload<Prisma.ContentUpsertArgs> | undefined, true>(
            'POST',
            `${endpoint}/content/upsert`,
            args,
            invalidate,
            fetch,
            true,
    ...
    async function deleteContent<T extends Prisma.ContentDeleteArgs>(
        args: Prisma.SelectSubset<T, Prisma.ContentDeleteArgs>,
    ) {
        return await request.mutationRequest<Prisma.ContentGetPayload<Prisma.ContentDeleteArgs> | undefined, true>(
            'DELETE',
    ...
    /** @deprecated Use `useDeleteManyContent` hook instead. */
    async function deleteManyContent<T extends Prisma.ContentDeleteManyArgs>(
        args: Prisma.SelectSubset<T, Prisma.ContentDeleteManyArgs>,
    ) {
        return await request.mutationRequest<Prisma.BatchPayload, false>(
            'DELETE',
            `${endpoint}/content/deleteMany`,
            args,
            invalidate,
            fetch,
            false,
    ...
    return { createContent, updateContent, updateManyContent, upsertContent, deleteContent, deleteManyContent };
}

export function useCreateContent(
    options?: MutationOptions<
        Prisma.ContentGetPayload<Prisma.ContentCreateArgs> | undefined,
        unknown,
...
export function useFindManyContent<T extends Prisma.ContentFindManyArgs>(
    args?: Prisma.SelectSubset<T, Prisma.ContentFindManyArgs>,
    options?: QueryOptions<Array<Prisma.ContentGetPayload<T> & { $optimistic?: boolean }>>,
) {
    return request.useModelQuery('Content', 'findMany', args, options);
}

export function useInfiniteFindManyContent<
    T extends Prisma.ContentFindManyArgs,
    R extends Array<Prisma.ContentGetPayload<T>>,
>(
    getNextArgs: GetNextArgs<Prisma.SelectSubset<T, Prisma.ContentFindManyArgs> | undefined, R>,
    options?: InfiniteQueryOptions<Array<Prisma.ContentGetPayload<T>>>,
) {
    return request.useInfiniteModelQuery('Content', 'findMany', getNextArgs, options);
}

export function useFindUniqueContent<T extends Prisma.ContentFindUniqueArgs>(
    args?: Prisma.SelectSubset<T, Prisma.ContentFindUniqueArgs>,
    options?: QueryOptions<Prisma.ContentGetPayload<T> & { $optimistic?: boolean }>,
) {
    return request.useModelQuery('Content', 'findUnique', args, options);
}

export function useFindFirstContent<T extends Prisma.ContentFindFirstArgs>(
...
export function useUpdateContent(
    options?: MutationOptions<
        Prisma.ContentGetPayload<Prisma.ContentUpdateArgs> | undefined,
        unknown,
...
export function useUpdateManyContent(
    options?: MutationOptions<Prisma.BatchPayload, unknown, Prisma.ContentUpdateManyArgs>,
) {
    const mutation = request.useModelMutation('Content', 'PUT', 'updateMany', metadata, options, false);
    return {
        ...mutation,
        trigger: <T extends Prisma.ContentUpdateManyArgs>(
            args: Prisma.SelectSubset<T, Prisma.ContentUpdateManyArgs>,
        ) => {
...
export function useUpsertContent(
    options?: MutationOptions<
        Prisma.ContentGetPayload<Prisma.ContentUpsertArgs> | undefined,
        unknown,
...
export function useDeleteContent(
    options?: MutationOptions<
        Prisma.ContentGetPayload<Prisma.ContentDeleteArgs> | undefined,
        unknown,
...
export function useDeleteManyContent(
    options?: MutationOptions<Prisma.BatchPayload, unknown, Prisma.ContentDeleteManyArgs>,
) {
    const mutation = request.useModelMutation('Content', 'DELETE', 'deleteMany', metadata, options, false);
    return {
        ...mutation,
        trigger: <T extends Prisma.ContentDeleteManyArgs>(
            args: Prisma.SelectSubset<T, Prisma.ContentDeleteManyArgs>,
        ) => {
            return mutation.trigger(args, options as any) as Promise<Prisma.BatchPayload>;
        },
...
export function useAggregateContent<T extends Prisma.ContentAggregateArgs>(
    args?: Prisma.Subset<T, Prisma.ContentAggregateArgs>,
    options?: QueryOptions<Prisma.GetContentAggregateType<T>>,
) {
    return request.useModelQuery('Content', 'aggregate', args, options);
}

export function useGroupByContent<
    T extends Prisma.ContentGroupByArgs,
...
>(
    args?: Prisma.SubsetIntersection<T, Prisma.ContentGroupByArgs, OrderByArg> & InputErrors,
    options?: QueryOptions<
        {} extends InputErrors
            ? Array<
                  PickEnumerable<Prisma.ContentGroupByOutputType, T['by']> & {
...
export function useCountContent<T extends Prisma.ContentCountArgs>(
    args?: Prisma.Subset<T, Prisma.ContentCountArgs>,
    options?: QueryOptions<
