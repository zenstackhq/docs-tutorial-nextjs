...
export function useCreatePost(options?: MutationOptions<Prisma.PostGetPayload<Prisma.PostCreateArgs> | undefined, unknown, Prisma.PostCreateArgs>) {
...
export function useFindManyPost<T extends Prisma.PostFindManyArgs>(args?: Prisma.SelectSubset<T, Prisma.PostFindManyArgs>, options?: QueryOptions<Array<Prisma.PostGetPayload<T> & { $optimistic?: boolean }>>) {
    return request.useModelQuery('Post', 'findMany', args, options);
}

export function useInfiniteFindManyPost<T extends Prisma.PostFindManyArgs, R extends Array<Prisma.PostGetPayload<T>>>(getNextArgs: GetNextArgs<Prisma.SelectSubset<T, Prisma.PostFindManyArgs> | undefined, R>, options?: InfiniteQueryOptions<Array<Prisma.PostGetPayload<T>>>) {
    return request.useInfiniteModelQuery('Post', 'findMany', getNextArgs, options);
}

export function useFindUniquePost<T extends Prisma.PostFindUniqueArgs>(args?: Prisma.SelectSubset<T, Prisma.PostFindUniqueArgs>, options?: QueryOptions<Prisma.PostGetPayload<T> & { $optimistic?: boolean }>) {
    return request.useModelQuery('Post', 'findUnique', args, options);
}

export function useFindFirstPost<T extends Prisma.PostFindFirstArgs>(args?: Prisma.SelectSubset<T, Prisma.PostFindFirstArgs>, options?: QueryOptions<Prisma.PostGetPayload<T> & { $optimistic?: boolean }>) {
    return request.useModelQuery('Post', 'findFirst', args, options);
}

export function useUpdatePost(options?: MutationOptions<Prisma.PostGetPayload<Prisma.PostUpdateArgs> | undefined, unknown, Prisma.PostUpdateArgs>) {
...
export function useUpsertPost(options?: MutationOptions<Prisma.PostGetPayload<Prisma.PostUpsertArgs> | undefined, unknown, Prisma.PostUpsertArgs>) {
...
export function useDeletePost(options?: MutationOptions<Prisma.PostGetPayload<Prisma.PostDeleteArgs> | undefined, unknown, Prisma.PostDeleteArgs>) {
...
export function useAggregatePost<T extends Prisma.PostAggregateArgs>(args?: Prisma.Subset<T, Prisma.PostAggregateArgs>, options?: QueryOptions<Prisma.GetPostAggregateType<T>>) {
...
export function useGroupByPost<T extends Prisma.PostGroupByArgs, HasSelectOrTake extends Prisma.Or<Prisma.Extends<'skip', Prisma.Keys<T>>, Prisma.Extends<'take', Prisma.Keys<T>>>, OrderByArg extends Prisma.True extends HasSelectOrTake ? { orderBy: Prisma.PostGroupByArgs['orderBy'] } : { orderBy?: Prisma.PostGroupByArgs['orderBy'] }, OrderFields extends Prisma.ExcludeUnderscoreKeys<Prisma.Keys<Prisma.MaybeTupleToUnion<T['orderBy']>>>, ByFields extends Prisma.MaybeTupleToUnion<T['by']>, ByValid extends Prisma.Has<ByFields, OrderFields>, HavingFields extends Prisma.GetHavingFields<T['having']>, HavingValid extends Prisma.Has<ByFields, HavingFields>, ByEmpty extends T['by'] extends never[] ? Prisma.True : Prisma.False, InputErrors extends ByEmpty extends Prisma.True
    ...
    : {
        ...
        ? never
        : `Error: Field "${P}" in "orderBy" needs to be provided in "by"`
    }[OrderFields]>(args?: Prisma.SubsetIntersection<T, Prisma.PostGroupByArgs, OrderByArg> & InputErrors, options?: QueryOptions<{} extends InputErrors ?
        Array<PickEnumerable<Prisma.PostGroupByOutputType, T['by']> &
            {
