...
export function useCheckUser(args: { operation: PolicyCrudKind; where?: { id?: string; name?: string; email?: string; password?: string; image?: string }; }, options?: QueryOptions<boolean>) {
